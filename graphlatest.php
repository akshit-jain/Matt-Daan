...
$year ='2020';
$t1n = "SELECT count(*) as c from complain where year(date) ='".$year."' and crime_type = 'impersonat';";
$t2n = "SELECT count(*) as c from complain where year(date) ='".$year."' and crime_type = 'booth-capturing';";
$t3n = "SELECT count(*) as c from complain where year(date) ='".$year."' and crime_type = 'murder';";
$t4n = "SELECT count(*) as c from complain where year(date) ='".$year."' and crime_type = 'blackmail';";
$t5n = "SELECT count(*) as c from complain where year(date) ='".$year."' and crime_type = 'bribe';";
$t6n = "SELECT count(*) as c from complain where year(date) ='".$year."' and crime_type = 'other';";
