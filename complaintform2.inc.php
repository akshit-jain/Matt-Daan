<?php
	...
	$query = "INSERT INTO complain (name, email, voter_id, response, crime_type, date, latitude, longitude, proof_doc) VALUES ('".$name."','".$email."','".$voterid."','".$responseOrg."','".$type."','".$date."','".$lat."','".$lon."','".$target_file."');";

		//$query = "INSERT INTO reports (name, email, voter_id, description, proof_doc) VALUES ('".$name."','".$email."','".$voterid."','".$responseOrg."','".$target_file."');";
